...
const Modal = ({ isOpen, onClose }) => {
    ...
    const handleAddBook = (event) => {
        ...
        dispatch(addBook({ id: Date.now(), title, author, category, created_at, description_short, description_long, img_url }));
        onClose();
    };
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form id='addBookForm' onSubmit={handleAddBook}>
                                ...
                                <input name='Kategori' type="text" placeholder='Kitap Kategori:' />
                                <input name='created-at' type="date" placeholder='Kitap Tarih:' />
                                <input name='Kısa-Tanım' type="text" placeholder='Kitap Kısa Tanım:' />
                                <input name='Uzun-Tanım' type="text" placeholder='Kitap Uzun Tanım:' />
                        ...
                        <div className="modal-footer">
                            ...
                            <button onClick={(e) => handleAddBook(e)} type="submit" form='addBookForm' className="btn btn-primary">Kaydet</button>
                        </div>
                    </div>
                </div>
            </div>
