...
const SubscribeView = () => {
  return (
    <section className="w-100 mx-5 mt-5">
      <div className=" container section d-flex flex-column justify-content-center align-items-center subscribe py-4" id="subscribe">
      ...
      <div className="row">
        <div className="col-12 align-items-center d-flex justify-content-center">
          <input type="email" name="subs" id="subs" className="me-0" />
