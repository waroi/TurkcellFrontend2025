...
const LibraryAbout = () => {
  return (
    <div className="about-container">
      <h1>Hakkımızda</h1>
      <p>
        Kitapseverler için kurulmuş olan <strong>[Kütüphane Adı]</strong>, bilgiye erişimi
        kolaylaştırmayı ve okuma alışkanlığını yaymayı amaçlayan bir platformdur.
      </p>
      ...
      <div className="contact-info">
        ...
        <p>📧 E-Posta: <a href="mailto:[E-posta Adresi]">mustafatihgunduz@gmail.com</a></p>
      </div>
    </div>
  );
};
