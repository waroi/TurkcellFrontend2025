      ...
      <div className="container" id="container" ref={containerRef}>
        ...
        <div className="form-container sign-in">
          <form onSubmit={handleLoginWithSignIn}>
            ...
            <button
              onClick={async () =>
                await signWithEmailAndPassword(email, password, navigate)
              }
            >
              Giriş yap
            </button>
        ...
        <div className="toggle-container">
          <div className="toggle">
            <div className="toggle-panel toggle-left">
              ...
              <p>
                Kullanıcı bilgilerini girerek kitap dünyasının içine adım at
              </p>
            ...
            <div className="toggle-panel toggle-right">
              ...
              <p>
                Sana uygun seçeneklerden birini seçerek kitap dünyasının
                kapılarını arala ve hemen kayıt ol
              </p>
