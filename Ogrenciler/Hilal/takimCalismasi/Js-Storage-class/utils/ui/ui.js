...
export const createCard = (parentElement, movie) => {
  ...
  descriptionLabel.className = "fw-bold ";
  ...
  movieTypeLabel.className = "fw-bold ";
  ...
  if (movie.movieType === "festival") {
    const festivalLabel = document.createElement("label");
    festivalLabel.className = "fw-bold ";
