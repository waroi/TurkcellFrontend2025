...
// 0-10 arasında sayı tutmak zorunda;bilgisayar sayı tutar,kul sayı tahmin eder, bilgisayar aşağı yukarı diye yönlendirir, kull tekrar sayı girer
const randomNumber = Math.floor(Math.random() * 10);
console.log(randomNumber);
const inputValue = Document.querySelector("#fname");
