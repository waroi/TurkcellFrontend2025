        ...
        <header className='mt-20'>
          <div className='container-fluid py-5 text-white text-center'>
            <h1 className='fw-bold'>
              <i className='bi bi-info-circle'></i> HAKKIMIZDA
            </h1>
              ...
              <div className='card h-100 shadow-sm bg-extra-dark-purple'>
                <div className='card-body p-4 text-white'>
                  ...
                  <p className='card-text'>
                    CS:2 tutkunlarına özel, benzersiz bir alışveriş deneyimi
                    sunarak espor dünyasının en değerli oyuncularını,
                    silahlarını ve ekipmanlarını erişilebilir kılmak.
                  </p>
                </div>
              </div>
            </div>
            <div className='col-md-6'>
              <div className='card h-100 shadow-sm bg-extra-dark-purple'>
                <div className='card-body p-4 text-white'>
                  ...
                  <p className='card-text'>
                    Espor ekosisteminde lider platform olarak, oyuncular ve
                    taraftarlar arasında köprü kurmak ve CS:2 topluluğunu
                    güçlendirmek.
                  </p>
                </div>
              </div>
              ...
              <div className='card h-100 shadow-sm bg-extra-dark-purple'>
                <div className='card-body text-center p-4'>
                  ...
                  <h4 className='card-title fw-bold text-white'>
                    Güvenli{' '}
                    <span className='text-header-purple'>Alışveriş</span>
                  </h4>
                  <p className='card-text text-white'>
                    %100 güvenli ödeme sistemi ve garantili teslimat ile
                    hizmetinizdeyiz.
                  </p>
                </div>
              </div>
            ...
            <div className='col-md-4'>
              <div className='card h-100 shadow-sm bg-extra-dark-purple '>
                <div className='card-body text-center p-4'>
                  ...
                  <h4 className='card-title fw-bold text-white'>
                    Pro <span className='text-header-purple'>Oyuncular</span>
                  </h4>
                  <p className='card-text text-white'>
                    Dünyanın en iyi CS:2 oyuncularına erişim imkanı sunuyoruz.
                  </p>
                </div>
              </div>
            </div>
            <div className='col-md-4'>
              <div className='card h-100 shadow-sm bg-extra-dark-purple '>
                <div className='card-body text-center p-4'>
                  ...
                  <h4 className='card-title fw-bold text-white'>
                    7/24 <span className='text-header-purple'>Destek</span>
                  </h4>
                  <p className='card-text text-white'>
