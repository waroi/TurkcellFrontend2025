...
import CoinCard from "../../molecules/Card/CoinCard"

const CryptuCards = ({ dataInfos, logoInfos }: { dataInfos: any, logoInfos: any }) => {
    return (
            ...
            <div className="card-container">
                ...
                <div className="cards">
                    {dataInfos.map((element: any, index: number) => {
                        if (index < 4) {
                            return <CoinCard key={element.id} dataInfo={element} logoInfo={logoInfos[element.id]} />
                        }
