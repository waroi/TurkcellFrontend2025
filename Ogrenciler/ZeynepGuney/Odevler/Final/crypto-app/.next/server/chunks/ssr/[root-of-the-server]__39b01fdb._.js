...
__turbopack_context__.s({
    ...
    "fetchCryptoOhlcv": (()=>fetchCryptoOhlcv),
...
const fetchCryptoOhlcv = async (id)=>{
    const response = await fetch(`/api/crypto-price?type=ohlcv&ids=${id}`);
    if (!response.ok) {
        throw new Error(`HTTP error! status: ${response.status}`);
    }
    const data = await response.json();
    const quotes = data.data?.[id]?.quotes;
    if (!quotes || quotes.length === 0) return null;
    const latest = quotes[quotes.length - 1].quote.USD;
    return {
...
const CryptoCard = ({ symbol })=>{
    ...
    const [percentChange24h, setPercentChange24h] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [ohlcv, setOhlcv] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(null);
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    const [coinName, setCoinName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const loadData = async ()=>{
            ...
            try {
                ...
                const coin = listingsData.data.find((c)=>c.symbol === symbol);
                if (!coin) {
                    console.warn(`Symbol "${symbol}" için coin bulunamadı.`);
                    return;
                }
                setPrice(coin.quote.USD.price);
                setPercentChange24h(coin.quote.USD.percent_change_24h);
                ...
                const logoUrl = infoData.data?.[coin.id]?.logo || '';
                setLogo(logoUrl);
                const ohlcvData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$services$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchCryptoOhlcv"])(coin.id.toString());
                setOhlcv(ohlcvData);
            } catch (error) {
    ...
    if (!ohlcv || price === null || percentChange24h === null) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "p-4 border rounded-xl shadow-md text-red-500",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__39b01fdb._.js.map