...
const WalletBuyStep2 = () => {
    const router = useRouter()

    const translateBuy = useTranslations("Wallet").raw("buy")
    const buyStep2 = translateBuy.data.step2
    ...
    return (
        <>
            ...
            <div className="buy-step2">
                <Title className="fs-5 title" as="h4">
                    {buyStep2.title}
                </Title>
                <Paragraph className="description">
                    {buyStep2.description}
                </Paragraph>
            ...
            <div className="buy-step2 buystep-second">
                <Title className="fs-5 title" as="h4">{buyStep2.forms.title}</Title>
                <Title className="fs-6 subtitle mb-0" as="h5">{buyStep2.forms.subTitle}</Title>
                <FormField
                    id="account-name"
                    labelClass="buy-label"
                    label={buyStep2.forms.accName}
                ...
                <FormField
                    id="account-number"
                    labelClass="buy-label"
                    label={buyStep2.forms.accNumber}
                ...
                <FormField
                    id="swift-code"
                    labelClass="buy-label"
                    label={buyStep2.forms.switftCode}
                ...
                <FormField
                    id="bank-address"
                    labelClass="buy-label"
                    label={buyStep2.forms.bankAddress}
                ...
                <div className="buttons d-flex gap-3">
                    ...
                    <Button variant="primary-button"
                        ...
                        height={48}
                        onClick={() => router.push("/wallet/buy/step3")}>
                        <span className='px-2'>
                            {buyStep2.goButtonText}
                        </span>
                    </Button>
                </div>
            </div>
