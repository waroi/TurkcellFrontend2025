    ...
    <>
      <div className="container p-3">
        <div className="form-floating mb-3">
          ...
          <button className="btn btn-primary ms-2" onClick={getActor}>Oyuncu Ara</button>
        </div>
        ...
        <div className="row">
          ...
          <nav aria-label="Page navigation example">
            <ul className="pagination">
              <li className="page-item"><a className="page-link" href="#" onClick={() => setPages(pages - 1)}>Previous</a></li>
              <li className="page-item"><a className="page-link" href="#" onClick={() => setPages(pages + 1)}>Next</a></li>
            </ul>
          </nav>
        </div>
                ...
                <div className="card mb-3 p-3">
                  <div className="row g-0">
                    <div className="col-md-4">
                      <img src={actor.profile_path ? `https://image.tmdb.org/t/p/original/${actor.profile_path}` : 'https://ih1.redbubble.net/image.4905811447.8675/flat,750x,075,f-pad,750x1000,f8f8f8.jpg'}
                        className="img-fluid rounded-start" alt={actor.original_name} />
