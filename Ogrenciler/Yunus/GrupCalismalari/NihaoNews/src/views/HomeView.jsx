                                        ...
                                        <div key={index} className="col-lg-3 new-item my-4 rounded col-md-4 col-sm-6 col-12">
                                            <NavLink to={`/news/${item.title}`} className='h-100 d-flex flex-column'>
                                                <div className="new-image">
                                                    <img src={item.urlToImage ? item.urlToImage : 'https://img.freepik.com/free-psd/3d-rendering-news-sales-background_23-2150732563.jpg?t=st=1740909615~exp=1740913215~hmac=e24e8489fcda35d4d46b0bab5e7e7c30b3b2975224599f03f94e00f11eddf16c&w=2000'} className='img-fluid h-100 w-100 object-fit-cover' alt={item.title} />
                                                </div>
