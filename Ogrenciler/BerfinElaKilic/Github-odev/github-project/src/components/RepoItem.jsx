    ...
    <div className="border-top border-bottom d-flex justify-content-between align-items-center py-3">
      <div className="d-flex gap-2 flex-column">
        <div className="d-flex gap-2">
          ...
          <Badge bg="transparent" className='me-1 border d-inline rounded-pill' style={{ height: "max-content" }} text="secondary">
            Public
          </Badge>
        ...
        <div className="d-flex repo-info align-items-center gap-5 text-secondary">
          {repoItem.language &&
            <div className="d-flex align-items-center gap-1">
              <span className="lang-color" style={{ backgroundColor: langColor }}></span>
              {repoItem.language}
            </div>
          }
