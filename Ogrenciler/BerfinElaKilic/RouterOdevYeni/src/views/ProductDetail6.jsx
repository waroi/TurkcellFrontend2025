      ...
      <div class="container my-5">
        <div class="row">
          <div class="col-md-12 col-12 col-lg-6">
            <img src="/src/assets/yatla-gezen.jpeg" alt="Ürün Görseli" class="product-image img-fluid"/>
          </div>
          <div class="col-md-12 col-12 col-lg-6">
            <div class="product-details">
              ...
              <h1 class="product-title">Yatla Gezen İnsan</h1>
              <p class="product-price text-primary fs-2">$65.000.000</p>
              <p class="product-description fs-5">
                Merhaba gelin hep beraber Yatla Gezen İnsanı birlikte inceleyelim...
                Okyanusun derin sularında balık gibi gezindiğinizi düşünün. 
                Belki solungaçlarınız olmayacak ama okyanusun derinlerine daldıktan 
                sonra yatınızda orkinoz salatasını anasonlu ayrana benzeyen içecek eşliğinde yiyebileceksiniz. 
                Jack Sparrow edası ile korsancılık oynarken keşfedilmemiş doğa harikalarının keşfine çıkıp 
                aynı zamanda hayallerinizdeki hayatı devasa bu yatta yaşayabilirsiniz. Bu harika deneyim için hemen satın alın.
              </p>
