          ...
          <div className="row">
            ...
            <div className="col-md-12 col-12 col-lg-6">
              <div className="product-details">
                ...
                <h1 className="product-title">Adada Yaşayan İş İnsanı</h1>
                <p className="product-price text-primary fs-2">$80.000.000</p>
                <p className="product-description fs-5">
                  Merhaba gelin hep beraber Adada Yaşayan İş İnsanını birlikte
                  inceleyelim... Küçük bir hatırlatma ile başlamakta fayda var.
                  Bu bahsettiğimiz kişi Survivor Adasındaki siyah tişörtlü Acun
                  değil tabi ki. Adanın neredeyse tüm kenarlarını kaplayan
                  hayallerinizdeki villaya sahip olduğunuzu düşünün. Adada bir
                  sabah uyandığınızda dalgaların kayalara çarpışının sonucu
                  çıkan doğa harikası ses ile uyanıp denizden gelen rüzgarın
                  teninizle buluşmasını hayal edin... Deniz tutkunları için tam
                  anlamıyla bir yavru cennet.
                </p>
