          ...
          <div class="container my-5">
            <div class="row">
              <div class="col-12 col-md-12 col-lg-6">
                <img src="/src/assets/casinocu.jpeg" alt="Ürün Görseli" class="product-image img-fluid"/>
              </div>
              <div class="col-12 col-md-12 col-lg-6">
                <div class="product-details">
                  ...
                  <h1 class="product-title">Lüks Casino Sahibi</h1>
                  <p class="product-price text-primary fs-2">$45.000.000</p>
                  <p class="product-description fs-5">
                    Merhaba gelin hep beraber Lüks Casino Sahibini inceleyelim...
                    Ben hayatta şansa inanmam başarının sırrı kumar oynayan değil o kumarı oynatandır. 
                    Siz arka odada iskoç yapımı elma suyuna benzeyen acı içeceğinizi yudumlayıp para sayma 
                    makinesinin sesi ile rüyalara dalarken lüks casinonuzdaki salonlarda Serdar ortaç gibi kumar 
                    bağımlıları ellerinde zar ve kağıt desteleri ile dedelerinin tarla tapularını güzel kurpiyerlerinize teslim edecek.
                  </p>
