          ...
          <div class="container my-5">
            <div class="row">
              <div class="col-md-12 col-lg-6 col-12">
                <img src="/src/assets/sarkici.jpeg" alt="Ürün Görseli" class="product-image img-fluid"/>
              </div>
              <div class="col-md-12 col-12 col-lg-6">
                <div class="product-details">
                  ...
                  <h1 class="product-title">Megastar Şarkıcı</h1>
                  <p class="product-price text-primary fs-2">$70.000.000</p>
                  <p class="product-description fs-5">
                    Merhaba gelin hep beraber megastar şarkıcıyı birlikte inceleyelim...
                    Ses kontrol öhööm öhöömm…
                    Neyse sözü uzatmadan başlayalım. Konserinizde binlerce insanın parçalarınızla 
                    ritim tuttuğunuzu düşünün. Dillere pelesenk olmuş şarkıların sahibi ve hit listesinin 1 numarasının 
                    vazgeçilmez ismi olduğunuzu, hayranlarınızın sizin benzersiz şarkılarınızı dinlemek için 
                    kuyruk oluşturduğunu düşünün. Şöhretin tam ortasında paparazzilerin peşinizde olduğu 
                    hızlı ve heyecanlı hayatınıza merhaba diyin ve bir de en çok izlenen ses yarışmasında 
                    dönen koltuk sahibi juri üyesi olmak eminim herkesin hayalidir.
                  </p>
